    ...
    var n = function() { this.el = t;
        ...
        this.setup = function() { this.el.css({ overflow: "hidden", width: n.max[0], height: this.items.first().outerHeight() });
            ...
            if (this.opts.fluid) {
                ...
                r();
                e(window).resize(r) }
            if (this.opts.arrows) { this.el.parent().append('<p class="arrows"><span class="prev">閳拷</span><span class="next">閳拷</span></p>').find(".arrows span").click(function() { e.isFunction(n[this.className]) && n[this.className]() }) }
